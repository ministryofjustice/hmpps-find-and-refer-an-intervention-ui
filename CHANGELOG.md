...
See PR [#441](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/441)
...
See PR [#439](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/439)
...
See PR [#435](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/435)
...
PR: [#412](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/412) and
PR: [#414](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/414). We also updated the documentation
...
can be found in PR: [#413](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/413) and
PR: [#415](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/415).
...
PR: [#388](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/388) and PR: [#378](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/378)
...
PR: [#377](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/377)
...
PR: [#388](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/388)
...
PR: [#375](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/375)
...
PR: [#365](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/365)
...
PR: [#352](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/352)

---

**February 29th 2024** – Use same node version for outdated check and security scan. This currently defaults to node 16

PR: [#321](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/321)

---

**February 15th 2024** – Move over to use Debian 12 based image (bookworm)

PR: [#316](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/316)
...
PR: [#297](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/297)
...
PR: [#274](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/274)

---

**November 29th 2023** – Use in-memory token store when developing locally

PR: [#273](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/273)

---

**November 6th 2023** – Add HMPPS Manage Users API to health checks

PR: [#255](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/255)
...
PR: [#252](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/252)
...
PR: [#249](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/249)
...
PR: [#247](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/247)
...
PR: [#238](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/238)
...
PR: [here](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/231)
...
PR: [here](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/212)
...
PR: [here](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/197)
...
PR: [here](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/178)
...
PR: [here](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/172)
...
PR: [here](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/170)
...
PR: [here](https://github.com/ministryofjustice/hmpps-find-and-refer-an-intervention-ui/pull/149)
